...
The official Fey SDK provides a complete, tested interface for interacting with the Fey Factory contract.
...
### 2. Token Deployment with SDK

The SDK provides two main functions for building deployment transactions:

**Simple Deployment** (recommended for most use cases):
```typescript
...
**Full Deployment** (for advanced configurations):
```typescript
...
### 3. Token Deployment Interface (Manual)
